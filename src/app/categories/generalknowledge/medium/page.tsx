...
function GeneralKnowledgeMedium() {
  ...
  const goToNextLevel = () => {
    router.push("https://questminds.vercel.app/categories/generalknowledge/hard");
  };
    ...
    >
      <div className="text-center container mx-auto max-w-xl">
        <div className="flex flex-row items-center justify-center font-bold text-xl mb-24">
          {/* CATEGORIA */}
          <h1 className="text-white text-2xl">General Knowledge: {""}</h1>
          {/* DIFFICULTY */}
...
export default GeneralKnowledgeMedium;
